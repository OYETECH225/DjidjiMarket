<div>
    <div class="mb-6 flex items-center justify-between">
        ...
        <button
            ...
            class="rounded-full border px-4 py-1.5 text-sm font-medium {{ $vendor->is_active ? 'border-djidji-green text-djidji-green' : 'border-red-300 text-red-600' }}"
        >
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <a href="{{ route('vendor.listings') }}" class="rounded-xl border border-black/5 bg-white p-5 shadow-sm hover:shadow-md">
        ...
        <a href="{{ route('vendor.orders') }}" class="rounded-xl border border-black/5 bg-white p-5 shadow-sm hover:shadow-md">
    ...
    <div class="mt-6 rounded-xl bg-white border border-black/5 p-4 text-sm text-djidji-text/70">
